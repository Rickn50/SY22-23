Module Module1
    ...
    Sub SolutionChecker()
        If Form1.Button1.Text = "1" And Form1.Button2.Text = "2" And Form1.Button3.Text = "3" And
            ...
            MessageBox.Show("Good Job, Ya Won", "Shuffle Game", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    ...
    Sub Shuffle()
        ...
        Form1.Button1.Text = a(2)
        Form1.Button1.Text = a(3)
        Form1.Button1.Text = a(4)
        Form1.Button1.Text = a(5)
        Form1.Button1.Text = a(6)
        Form1.Button1.Text = a(7)
        Form1.Button1.Text = a(8)
        Form1.Button1.Text = a(9)
        Form1.Button1.Text = a(10)
        Form1.Button1.Text = a(11)
        Form1.Button1.Text = a(12)
        Form1.Button1.Text = a(13)
        Form1.Button1.Text = a(14)
        Form1.Button1.Text = a(15)
        Form1.Button1.Text = ""
    End Sub
End Module
